...
#ifndef ZEPHYR_INCLUDE_DT_BINDINGS_RESET_GD32F10X_H_
#define ZEPHYR_INCLUDE_DT_BINDINGS_RESET_GD32F10X_H_
...
/**
 * @name Reset line definitions for peripherals
 * @{
 */
...
#endif /* ZEPHYR_INCLUDE_DT_BINDINGS_RESET_GD32F10X_H_ */
